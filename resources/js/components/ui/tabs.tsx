      ...
      <TabsPrimitive.Indicator
        className={cn(
          ...
          variant === "underline"
            ...
            : "-z-1 bg-background shadow-sm/5 rounded-md",
        )}
