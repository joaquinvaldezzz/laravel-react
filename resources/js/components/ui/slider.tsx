        ...
        >
          ...
          {Array.from({ length: values.length }, (_, index) => (
            <SliderPrimitive.Thumb
              className="border-input shadow-xs/5 not-dark:bg-clip-padding focus-visible:ring-ring/24 has-focus-visible:ring-[3px] has-focus-visible:ring-ring/24 data-dragging:scale-120 data-dragging:ring-[3px] data-dragging:ring-ring/24 [:focus-visible,[data-dragging]]:shadow-none block size-5 shrink-0 select-none rounded-full border bg-white outline-none transition-[box-shadow,scale] before:absolute before:inset-0 before:rounded-full before:shadow-[0_1px_--theme(--color-black/6%)] focus-visible:ring-[3px] sm:size-4"
