    ...
    <PreviewCardPrimitive.Portal>
      ...
      >
        <PreviewCardPrimitive.Popup
          className={cn(
            "origin-(--transform-origin) bg-popover text-popover-foreground shadow-lg/5 not-dark:bg-clip-padding data-ending-style:scale-98 data-ending-style:opacity-0 data-starting-style:scale-98 data-starting-style:opacity-0 relative flex w-64 text-balance rounded-lg border p-4 text-sm transition-[scale,opacity] before:pointer-events-none before:absolute before:inset-0 before:rounded-[calc(var(--radius-lg)-1px)] before:shadow-[0_1px_--theme(--color-black/6%)]",
            className,
          )}
